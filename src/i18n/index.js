...
const translations = {
  ru: {
    ...
    add: {
      ...
      remove: 'Удалить',
      color: 'Цвет',
      customColorHint: '#7C5CFF',
      removeColorTitle: 'Удалить цвет?',
      removeColorText: 'Цвет будет удалён из списка',
      colorLimit: 'Можно добавить до 5 цветов',
    ...
    premium: {
      ...
      feature3: 'Свои эмодзи и цвета',
      feature4: 'Приоритетная поддержка',
      cta: 'Оформить Premium',
      ctaPrefix: 'Оформить за',
      openCheckout: 'Перейти к оплате',
      waitingPayment: 'Ждём подтверждения оплаты — после оплаты вернись в приложение',
      checkStatus: 'Проверить сейчас',
      notReadyTitle: 'Платёж ещё не подтверждён',
      notReadyBody: 'Подожди пару секунд после оплаты и попробуй ещё раз',
      later: 'Не сейчас',
      restore: 'Восстановить покупки',
      restoring: 'Восстанавливаем…',
      restoreSuccessTitle: 'Готово',
      restoreSuccessBody: 'Premium восстановлен',
      restoreEmptyTitle: 'Покупок не найдено',
      restoreEmptyBody: 'На этом аккаунте нет активной подписки',
      errorTitle: 'Не удалось оформить',
      errorBody: 'Попробуй ещё раз через пару секунд',
  ...
  en: {
    ...
    add: {
      ...
      removeColorText: 'It will be removed from your custom set',
      colorLimit: 'Up to 5 custom colors',
      reminder: 'Reminder',
    ...
    premium: {
      ...
      feature3: 'Custom emojis and colors',
      feature4: 'Priority support',
      cta: 'Subscribe to Premium',
      ctaPrefix: 'Subscribe for',
      openCheckout: 'Continue to checkout',
      waitingPayment: 'Waiting for payment confirmation — return here after paying',
      checkStatus: 'Check now',
      notReadyTitle: 'Payment not confirmed yet',
      notReadyBody: 'Wait a few seconds after paying and try again',
      later: 'Not now',
      restore: 'Restore purchases',
      restoring: 'Restoring…',
      restoreSuccessTitle: 'Restored',
      restoreSuccessBody: 'Premium is active again',
      restoreEmptyTitle: 'Nothing to restore',
      restoreEmptyBody: 'No active subscription on this account',
